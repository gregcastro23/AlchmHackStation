...
const initialIntegrations: IntegrationRuntime[] = [
  ...
  },
  {
    ...
    role: 'Local keypair signing & cluster RPC bridge',
    health: 'healthy',
    auth: 'Local id.json keypair',
    statusCommand: 'solana address',
    loginCommand: 'solana-keygen new',
    expiry: 'Permanent keypair',
    message: 'Active Solana local keypair detected on Devnet.',
  },
  {
    id: 'anchor',
    label: 'Anchor Framework',
    role: 'Solana smart contract compilation & IDL synthesis',
    health: 'healthy',
    auth: 'Rust toolchain / Anchor CLI',
    statusCommand: 'anchor --version',
    loginCommand: 'cargo install --git https://github.com/coral-xyz/anchor avm',
    expiry: 'Opaque',
    message: 'Anchor CLI active for Token-2022 and Staking program IDL export.',
  },
  {
    id: 'spacetime',
    label: 'SpacetimeDB CLI',
    role: 'Real-time database sync & relational engine',
    health: 'healthy',
    auth: 'Spacetime identity session',
    statusCommand: 'spacetime --version',
    loginCommand: 'spacetime login',
    expiry: 'Opaque',
    message: 'SpacetimeDB CLI ready for Pentacles module reconciliation.',
  },
  {
    id: 'multisig-auth',
    label: 'Multisig Governance Auth',
    role: 'On-chain multisig signers & WebAuthn governance threshold',
    health: 'healthy',
    auth: 'Touch ID / WebAuthn + Solana keypair',
    statusCommand: 'solana config get',
    loginCommand: 'solana config set --url devnet',
    expiry: 'Session bound',
    message: 'Multisig authority threshold verified for AlchmAgentsSolana.',
  },
  {
    id: 'vercel',
